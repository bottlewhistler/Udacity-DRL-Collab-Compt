...
BATCH_SIZE = 350         # minibatch size
GAMMA = 0.99            # discount factor
TAU = 1e-3              # for soft update of target parameters
LR_ACTOR = 1e-4         # learning rate of the actor
LR_CRITIC = 1e-4        # learning rate of the critic 2539
...
class Agent():
    ...
    def __init__(self, state_size, action_size, sharedBuffer, random_seed, num_agents=2):
    ...
    def step(self):
        ...
        if len(self.sharedBuffer) > BATCH_SIZE:
            experiences = self.sharedBuffer.sample()
...
class MADDPG:
    """Multiple Agents interact with and learn from the environment."""
    def __init__(self, state_size, action_size, sharedBuffer, random_seed, num_agents=2):
        self.num_agents = num_agents
        self.action_size = action_size
        self.sharedBuffer = sharedBuffer
        self.random_seed = random_seed
        self.agents = [Agent(state_size,action_size,self.sharedBuffer,self.random_seed) for x in range(num_agents)]
